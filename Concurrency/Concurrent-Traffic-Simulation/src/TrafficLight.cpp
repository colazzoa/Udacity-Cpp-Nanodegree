...
void TrafficLight::waitForGreen()
{
    ...
    while (1)
    {
        ...
        TrafficLightPhase tlPhase =  _tlQueue.receive();
        if (TrafficLightPhase::green == tlPhase)
            return;
    }
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    while (true) {
        ...
        //std::cout << "duration [ms]: " << cycle_duration << " and t2 [ms]: " << t2 << std::endl;

        if (t2 >= cycle_duration) {
